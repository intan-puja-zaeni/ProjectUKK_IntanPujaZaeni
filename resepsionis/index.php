...
<html lang="en">
<head>
  <title>Resepsionis - Hotel Beehive Boutique</title>
  <meta charset="utf-8">
      ...
      <h4><a class="nav-link text-white">Resepsionis</a></h4> 
          ...
          <div class="collapse navbar-collapse" id="collapsibleNavbar">
           <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
            <li class="nav-item">
             <h5><a class="nav-link" href="http://localhost/hotelmanagement/resepsionis/index.php#">Reservasi Hotel</a></h5> 
            </li>
          </ul>     
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h4 class="modal-title text-center">Data Reservasi</h4>
