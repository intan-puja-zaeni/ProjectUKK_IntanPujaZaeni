         ...
         <table id="tb_kamar" class="table table-striped" style="width:100%">
          ...
          <tbody>
            ...
            <tr>
                ...
                <td class="text-center"><?php echo $row["hargapermalam"]; ?></td>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="form_k">
          ...
          <div class="mb-3 mt-3 form-floating">
            <input type="text" class="form-control" id="hargapermalam" name="hargapermalam">
...
$(function(){	
    $("#add_kamar").on('click', function(){
     ...
     var harga   = $("#hargapermalam").val();
     var jkamar  = $("#jml_kamar").val();

	 if ( (nama=="") || (harga=="") || (jkamar=="") )
	 {
...
$(function(){	
    $("#update_kamar").on('click', function(){
     ...
     var eharga = $("#ehargapermalam").val();
     var ejkamar  = $("#ejml_kamar").val();

	 if ( (enama=="") || (eharga=="") || (ejkamar==""))
	 {
        alert("Terjadi kesalahan. Ada data yang kosong!");
        return;
	 }
